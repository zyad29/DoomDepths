...
void attaquerMonstre(struct Monstre *monstre, Joueur *joueur, struct Sorts *sorts, int attaque, int indiceMonstre, int choixSort) {
    int degats;
        ...
        while (attaquesRestantes > 0) {
            ...
            if(choixMonstre=='j'){
                ...
                if (monstres[choixMonstre-48 - 1].vie <= 0) {
                    ...
                    attaquerMonstre(&monstres[choixMonstre -48- 1], joueur,&sorts, attaque, choixMonstre-48, choixSort);
                    attaquesRestantes--;
                }
